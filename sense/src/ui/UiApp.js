...
var UiApp = (function () {
  ...
  _createClass(UiApp, [{
    ...
    value: function getModules() {
      return _.chain([this.autoloadOverrides || autoload.require, this.uiExports.find(_.get(this, 'spec.uses', [])), this.uiExports.find(['chromeNavControls'])]).flatten().uniq().unshift(this.main).value();
    }
  }, {
    key: 'toJSON',
